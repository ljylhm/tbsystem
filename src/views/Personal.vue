  ...
  <div class="personal-container">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="showPwdModal = false"
          >返回修改</el-button
        >
      </span>
    </el-dialog>
    ...
    <div class="person-right">
      <div class="person-page-container">
        ...
        <div class="person-page-right">
          ...
          <div class="person-tips_item">
            账户余额<span class="zy-font">{{userInfo.amount || 0}}</span>元
          </div>
          <div class="person-tips_item">
...
export default class Home extends Vue {
  ...
  created() {
    httpGet<IUser>("/api/current").then((data) => {
      if (data && data.data) {
